-- =============================================================================
-- 038_p4_canonical_market.sql -- the canonical market surface
-- =============================================================================
-- One row per (event_id, market_type, selection, line). The sportsbook is
-- deliberately NOT in the key -- aggregating across books is the point.
--
-- SAME-LINE ONLY. Nothing here ever compares or blends across line values.
-- Live data made this non-negotiable: 64.3% of spread and 79.4% of total
-- event/selections carry more than one line at once, so collapsing by
-- (event, selection) alone would quietly mix different wagers.
--
-- Quality is ADVISORY here. No row is ever withheld -- a consumer may always
-- see the raw truth and decide. Gating lives in the executable surface (039).
-- =============================================================================

CREATE VIEW public.canonical_market
