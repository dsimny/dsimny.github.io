...
<style>
  ...
  * {{ box-sizing:border-box; margin:0; }}
  ...
  .wordmark {{ font-weight:800; letter-spacing:0.04em; font-size:1.05rem; }}
  .wordmark .open {{ color:var(--s1); }}
  .wordmark small {{ display:block; font-weight:500; font-size:0.62rem; letter-spacing:0.14em; color:var(--muted); text-transform:uppercase; }}
...
<header class="site"><div class="wrap sitebar">
  <div class="wordmark"><span class="open">OPEN LEDGER</span> SPORTS<small>Every pick on the record. Every rule in public.</small></div>
